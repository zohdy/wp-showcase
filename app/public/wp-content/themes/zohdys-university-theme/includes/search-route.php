<?php
	...
	function universitySearchResults($data){
		...
		if($searchResults['programs']){
			...
			$searchResults['professors'] = array_values(
				array_unique($searchResults['professors'], SORT_REGULAR));

			$searchResults['events'] = array_values(
				array_unique($searchResults['events'], SORT_REGULAR));
		}
